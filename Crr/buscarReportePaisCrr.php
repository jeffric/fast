...
<!DOCTYPE html>
<html>
<?php echo $c_funciones->getHeaderNivel2("Buscar Reporte CRR País", 
	'  <style>
  .panel-content {
    padding: 1em;
  }
...
<div data-role="page" id="page">
		...
		<div role="main" class="ui-content">
			<p align="center"><strong>Paises</strong><br />
						...
						<table data-role="table" id="movie-table" data-filter="true" data-input="#filterTable-input" class="ui-responsive">
						    <thead>
						        <tr>
						            ...
						            <th data-priority="2">Nombre Pais</th>
						            <th data-priority="3">Creador</th>
						        </tr>
						        </thead>
						        <tbody>
<?php
								$result = $c_funciones->getReportesCrrPais($strTipoUsuario,$idUsuario);
