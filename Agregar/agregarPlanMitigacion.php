...
<div data-role="page" id="page">
		...
		<div role="main" class="ui-content">
			...
			<div class="ui-body ui-body-a ui-corner-all">
					...
					<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
						<a href="#"  data-role="button" id="botonAgregar">Agregar Plan de Mitigación</a>
					</div> 	
			</div>		
...
<div id="pageMensaje" data-role="dialog" data-theme="b" >
    <header data-role="header">
      ...
      <br>           
            <a href="../Agregar/agregarPlanMitigacion.php" data-role="button" id="btn" data-ajax="false">Aceptar</a>
            </center>
           </article>
</div>
