...
<!DOCTYPE html>
<html>
<?php echo $c_funciones->getHeaderNivel2("Reportes Hiss-Cam", 
	'  <style>
  .panel-content {
    padding: 1em;
  }
...
<div data-role="page" id="page">
		<?php $c_funciones->getHeaderPageNivel2("FAST Hiss-Cam"); ?>
		<div role="main" class="ui-content">
				<div class="ui-body ui-body-a ui-corner-all">

<?php
				$result=$c_funciones->getReporteHissCam($idReporte);
			...
			$("#btnCorreo").click(function(){
				...
				alert(<?php echo $idReporte; ?>);
			      $.ajax({
		                  ...
		                  data: {nombreMetodo: "sendGMail", AjxTipoReporte: 4, mails:correos, Asunto:"World Vision - Reporte HISS-CAM", AjxIDReporte:<?php echo $idReporte; ?> },
